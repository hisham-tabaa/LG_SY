...
class EnhancedCamera {
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <div id="cameraContainer" class="position-relative">
                                ...
                                <div id="cameraOverlay" class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center pointer-events-none">
                                    <div class="border border-primary border-3 rounded" style="width: 80%; height: 60%; background: rgba(0,123,255,0.1);">
                                        <div class="text-center mt-2">
                                            <small class="text-white bg-primary px-2 py-1 rounded lang-en">Position serial number here</small>
                                            <small class="text-white bg-primary px-2 py-1 rounded lang-ar" style="display: none;">ضع الرقم التسلسلي هنا</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="capturedImageContainer" class="mt-3 d-none">
                                <img id="capturedImage" class="img-fluid rounded border" style="max-height: 300px;">
                                <div class="mt-2">
                                    <button id="useCapturedBtn" class="btn btn-success btn-lg">
                                        <i class="bi bi-check-circle"></i>
                                        <span class="lang-en">Process This Image</span>
                                        <span class="lang-ar" style="display: none;">معالجة هذه الصورة</span>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="mt-3">
                                <small class="text-muted lang-en">
                                    💡 Tips: Ensure good lighting, hold steady, and position the serial number within the frame
                                </small>
                                <small class="text-muted lang-ar" style="display: none;">
                                    💡 نصائح: تأكد من الإضاءة الجيدة، امسك الجهاز بثبات، وضع الرقم التسلسلي داخل الإطار
                                </small>
                            </div>
                        </div>
                    </div>
    ...
    async useCapturedImage() {
        ...
        // Show loading and process using existing uploadSerialImage logic
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (data.extracted_text) {
                    ...
                    extraInfo = currentLanguage === 'en' ? 
                        `💡 Camera capture tips:\n• Ensure good lighting\n• Hold camera steady\n• Position serial number clearly in frame\n• For best results, enter the serial number manually above` : 
                        `💡 نصائح التصوير:\n• تأكد من الإضاءة الجيدة\n• امسك الكاميرا بثبات\n• ضع الرقم التسلسلي بوضوح في الإطار\n• للحصول على أفضل النتائج، أدخل الرقم التسلسلي يدوياً أعلاه`;
                }
            ...
            const errorMsg = currentLanguage === 'en' ? 
                'Failed to process camera image. Please try again or enter the serial number manually.' :
                'فشل في معالجة صورة الكاميرا. يرجى المحاولة مرة أخرى أو إدخال الرقم التسلسلي يدوياً.';
